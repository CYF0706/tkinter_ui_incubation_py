...
class WinGUI(Tk):
    ...
    def __tk_button_set_button(self,parent):
        ...
        btn.place(x=160, y=670, width=195, height=69)
        return btn
    def __tk_button_reset_button(self,parent):
        btn = Button(parent, text="重置", takefocus=False,)
        btn.place(x=520, y=670, width=198, height=68)
        return btn
    def __tk_input_temp_input(self,parent):
        ipt = Entry(parent, )
        ipt.place(x=240, y=450, width=175, height=58)
        return ipt
    def __tk_input_light_input(self,parent):
        ipt = Entry(parent, )
        ipt.place(x=240, y=560, width=175, height=58)
        return ipt
    def __tk_input_wet_input(self,parent):
        ipt = Entry(parent, )
        ipt.place(x=780, y=450, width=175, height=58)
        return ipt
